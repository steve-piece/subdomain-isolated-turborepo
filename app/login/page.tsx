...
import { marketingDomain, appDomain, protocol } from '@/lib/utils';
...
export default function LoginPage() {
  ...
  const isMarketing = hostname === marketingRoot || hostname === `www.${marketingRoot}`;
  const isAppRoot = hostname === appRoot;
      ...
      <div className="w-full max-w-md space-y-6">
        {isMarketing || isAppRoot ? (
          ...
          <div className="space-y-4">
            ...
            <Link href={`${protocol}://${marketingRoot}/login`} className="text-blue-600 underline">
