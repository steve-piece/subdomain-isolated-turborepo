...
export interface UpdateSessionOptions {
   ...
   * Only applies to paths that don't start with /login or /auth.
   */
  requireAuth?: boolean;
  /**
   * Paths that should be excluded from auth checks (e.g., ["/login", "/auth"])
   */
  authExcludedPaths?: string[];
}

/**
 * Updates the Supabase session in middleware/proxy.
 * This refreshes the user's session and ensures cookies are properly set.
 *
