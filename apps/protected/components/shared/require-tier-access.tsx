    ...
    <div className="container max-w-4xl mx-auto p-6">
      <Card className="border-2 border-warning-muted shadow-lg">
        <CardHeader className="text-center pb-4 space-y-4">
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-linear-to-br from-amber-500 via-orange-500 to-amber-600 shadow-lg">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-2">
              {[
                ...
                >
                  <ArrowRight className="h-4 w-4 text-warning mt-0.5 shrink-0" />
                  <span>{benefit}</span>
                </div>
              ))}
            </div>
          ...
          {/* Pricing Preview */}
          <div className="bg-linear-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 rounded-lg p-4 border border-warning-muted dark:border-warning-muted">
