...
export function OrganizationDashboard({
  ...
  return (
    <div className="flex h-screen w-full flex-col">
      <header className="border-b bg-linear-to-r from-background to-muted/20 px-6 py-6 shadow-sm">
      ...
      <main className="flex-1 p-6 bg-linear-to-br from-background to-muted/30">
        <div className="mx-auto max-w-6xl space-y-6">
          {/* Welcome Card */}
          <Card className="bg-linear-to-r from-card to-card/50 shadow-lg">
            <CardHeader>
